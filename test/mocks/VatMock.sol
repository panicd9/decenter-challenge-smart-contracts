...
contract VatMock {
    ...
    // USED FOR MOCKING
    function setIlks(bytes32 ilk, uint256 totalDebt, uint256 rate) public {
        ilks[ilk] = Ilk(totalDebt, rate, 0, 0, 0);
    }

    function setUrns(bytes32 ilk, address urn, uint256 collateral, uint256 _debt) public {
        urns[ilk][urn] = Urn(collateral, _debt);
    }
}
